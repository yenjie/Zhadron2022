...
BackgroundMC="   --DoBackground true --HFShift 682  --Tolerance 10000000 --ToleranceFraction 0.001 --VZTolerance 10000000 --Oversample 1 --HFCeiling 134000 --MaximumCentrality 10"
