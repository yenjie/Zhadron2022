...
int main(int argc, char *argv[])
{
   ...
   double TreeMu1TnP1P2, TreeMu1TnP2P2, TreeMu1TnP3P2, TreeMu2TnP1P2, TreeMu2TnP2P2, TreeMu2TnP3P2;
   double TreeMu1TnP1N2, TreeMu1TnP2N2, TreeMu1TnP3N2, TreeMu2TnP1N2, TreeMu2TnP2N2, TreeMu2TnP3N2;
   ...
   Tree.Branch("Mu1TnP1P1", &TreeMu1TnP1P1, "Mu1TnP1P1/D");
   Tree.Branch("Mu1TnP2P1", &TreeMu1TnP2P1, "Mu1TnP2P1/D");
   Tree.Branch("Mu1TnP3P1", &TreeMu1TnP3P1, "Mu1TnP3P1/D");
   Tree.Branch("Mu2TnP1P1", &TreeMu2TnP1P1, "Mu2TnP1P1/D");
   Tree.Branch("Mu2TnP2P1", &TreeMu2TnP2P1, "Mu2TnP2P1/D");
   Tree.Branch("Mu2TnP3P1", &TreeMu2TnP3P1, "Mu2TnP3P1/D");
   Tree.Branch("Mu1TnP1N1", &TreeMu1TnP1N1, "Mu1TnP1N1/D");
   Tree.Branch("Mu1TnP2N1", &TreeMu1TnP2N1, "Mu1TnP2N1/D");
   Tree.Branch("Mu1TnP3N1", &TreeMu1TnP3N1, "Mu1TnP3N1/D");
   Tree.Branch("Mu2TnP1N1", &TreeMu2TnP1N1, "Mu2TnP1N1/D");
   Tree.Branch("Mu2TnP2N1", &TreeMu2TnP2N1, "Mu2TnP2N1/D");
   Tree.Branch("Mu2TnP3N1", &TreeMu2TnP3N1, "Mu2TnP3N1/D");
   Tree.Branch("Mu1TnP1P2", &TreeMu1TnP1P2, "Mu1TnP1P2/D");
   Tree.Branch("Mu1TnP2P2", &TreeMu1TnP2P2, "Mu1TnP2P2/D");
   Tree.Branch("Mu1TnP3P2", &TreeMu1TnP3P2, "Mu1TnP3P2/D");
   Tree.Branch("Mu2TnP1P2", &TreeMu2TnP1P2, "Mu2TnP1P2/D");
   Tree.Branch("Mu2TnP2P2", &TreeMu2TnP2P2, "Mu2TnP2P2/D");
   Tree.Branch("Mu2TnP3P2", &TreeMu2TnP3P2, "Mu2TnP3P2/D");
   Tree.Branch("Mu1TnP1N2", &TreeMu1TnP1N2, "Mu1TnP1N2/D");
   Tree.Branch("Mu1TnP2N2", &TreeMu1TnP2N2, "Mu1TnP2N2/D");
   Tree.Branch("Mu1TnP3N2", &TreeMu1TnP3N2, "Mu1TnP3N2/D");
   Tree.Branch("Mu2TnP1N2", &TreeMu2TnP1N2, "Mu2TnP1N2/D");
   Tree.Branch("Mu2TnP2N2", &TreeMu2TnP2N2, "Mu2TnP2N2/D");
   Tree.Branch("Mu2TnP3N2", &TreeMu2TnP3N2, "Mu2TnP3N2/D");
      ...
      for(int iE = 0; iE < EntryCount; iE++)
      {
         ...
         for(int i = 0; i < NGen; i++)
         {
            ...
            if(IsPP == false)
            {
               ...
               pair<double, double> TnPTrigMu1 = tnp_trig_pbpb(PGenMu1[i].Pt(), PGenMu1[i].Eta(), TreeHiBin * 0.5, 0);
               pair<double, double> TnPTrigMu2 = tnp_trig_pbpb(PGenMu2[i].Pt(), PGenMu2[i].Eta(), TreeHiBin * 0.5, 0);
               
               // From Andre
               // (1 - (1 - eff_data(mu1)) x (1 - eff_data(mu2)))  / (1 - (1 - eff_MC(mu1)) x (1 - eff_MC(mu2)))
               TreeMu1TnP3 = 1;
               TreeMu2TnP3 = (1 - (1 - TnPTrigMu1.first) * (1 - TnPTrigMu2.first) / (1 - (1 - TnPTrigMu1.second) * (1 - TnPTrigMu2.second)));

               TreeMu1TnP1P1 = tnp_weight_glbPFtrk_pbpb(PGenMu1[i].Eta(), TreeHiBin * 0.5, 1);
               TreeMu1TnP2P1 = tnp_weight_muid_pbpb(PGenMu1[i].Eta(), 1);
               TreeMu1TnP3P1 = tnp_weight_trig_pbpb(PGenMu1[i].Pt(), PGenMu1[i].Eta(), TreeHiBin * 0.5, 1);
               TreeMu2TnP1P1 = tnp_weight_glbPFtrk_pbpb(PGenMu2[i].Eta(), TreeHiBin * 0.5, 1);
               TreeMu2TnP2P1 = tnp_weight_muid_pbpb(PGenMu2[i].Eta(), 1);
               TreeMu2TnP3P1 = tnp_weight_trig_pbpb(PGenMu2[i].Pt(), PGenMu2[i].Eta(), TreeHiBin * 0.5, 1);
               
               TreeMu1TnP1N1 = tnp_weight_glbPFtrk_pbpb(PGenMu1[i].Eta(), TreeHiBin * 0.5, -1);
               TreeMu1TnP2N1 = tnp_weight_muid_pbpb(PGenMu1[i].Eta(), -1);
               TreeMu1TnP3N1 = tnp_weight_trig_pbpb(PGenMu1[i].Pt(), PGenMu1[i].Eta(), TreeHiBin * 0.5, -1);
               TreeMu2TnP1N1 = tnp_weight_glbPFtrk_pbpb(PGenMu2[i].Eta(), TreeHiBin * 0.5, -1);
               TreeMu2TnP2N1 = tnp_weight_muid_pbpb(PGenMu2[i].Eta(), -1);
               TreeMu2TnP3N1 = tnp_weight_trig_pbpb(PGenMu2[i].Pt(), PGenMu2[i].Eta(), TreeHiBin * 0.5, -1);
               
               TreeMu1TnP1P2 = tnp_weight_glbPFtrk_pbpb(PGenMu1[i].Eta(), TreeHiBin * 0.5, 2);
               TreeMu1TnP2P2 = tnp_weight_muid_pbpb(PGenMu1[i].Eta(), 2);
               TreeMu1TnP3P2 = tnp_weight_trig_pbpb(PGenMu1[i].Pt(), PGenMu1[i].Eta(), TreeHiBin * 0.5, 2);
               TreeMu2TnP1P2 = tnp_weight_glbPFtrk_pbpb(PGenMu2[i].Eta(), TreeHiBin * 0.5, 2);
               TreeMu2TnP2P2 = tnp_weight_muid_pbpb(PGenMu2[i].Eta(), 2);
               TreeMu2TnP3P2 = tnp_weight_trig_pbpb(PGenMu2[i].Pt(), PGenMu2[i].Eta(), TreeHiBin * 0.5, 2);
               
               TreeMu1TnP1N2 = tnp_weight_glbPFtrk_pbpb(PGenMu1[i].Eta(), TreeHiBin * 0.5, -2);
               TreeMu1TnP2N2 = tnp_weight_muid_pbpb(PGenMu1[i].Eta(), -2);
               TreeMu1TnP3N2 = tnp_weight_trig_pbpb(PGenMu1[i].Pt(), PGenMu1[i].Eta(), TreeHiBin * 0.5, -2);
               TreeMu2TnP1N2 = tnp_weight_glbPFtrk_pbpb(PGenMu2[i].Eta(), TreeHiBin * 0.5, -2);
               TreeMu2TnP2N2 = tnp_weight_muid_pbpb(PGenMu2[i].Eta(), -2);
               TreeMu2TnP3N2 = tnp_weight_trig_pbpb(PGenMu2[i].Pt(), PGenMu2[i].Eta(), TreeHiBin * 0.5, -2);
            }
            else
            {
               TreeMu1TnP1 = tnp_weight_TightID_pp(PGenMu1[i].Eta(), 0);
               TreeMu1TnP2 = tnp_weight_L3Mu12_pp(PGenMu1[i].Eta(), 0);
               TreeMu1TnP3 = 1;
               TreeMu2TnP1 = tnp_weight_TightID_pp(PGenMu2[i].Eta(), 0);
               TreeMu2TnP2 = tnp_weight_L3Mu12_pp(PGenMu2[i].Eta(), 0);
               TreeMu2TnP3 = 1;

               TreeMu1TnP2 = 1;
               TreeMu2TnP2 = 1;
               
               double TnPTrigMu1Data = eff_data_L3Mu12_pp(PGenMu1[i].Eta(), 0);
               double TnPTrigMu1MC   = eff_MC_L3Mu12_pp(PGenMu1[i].Eta(), 0);
               double TnPTrigMu2Data = eff_data_L3Mu12_pp(PGenMu2[i].Eta(), 0);
               double TnPTrigMu2MC   = eff_MC_L3Mu12_pp(PGenMu2[i].Eta(), 0);
               
               // From Andre
               // (1 - (1 - eff_data(mu1)) x (1 - eff_data(mu2)))  / (1 - (1 - eff_MC(mu1)) x (1 - eff_MC(mu2)))
               TreeMu1TnP3 = 1;
               TreeMu2TnP3 = (1 - (1 - TnPTrigMu1Data) * (1 - TnPTrigMu2Data) / (1 - (1 - TnPTrigMu1MC) * (1 - TnPTrigMu2MC)));
               
               TreeMu1TnP1P1 = tnp_weight_TightID_pp(PGenMu1[i].Eta(), 1);
               TreeMu1TnP2P1 = tnp_weight_L3Mu12_pp(PGenMu1[i].Eta(), 1);
               TreeMu1TnP3P1 = 1;
               TreeMu2TnP1P1 = tnp_weight_TightID_pp(PGenMu2[i].Eta(), 1);
               TreeMu2TnP2P1 = tnp_weight_L3Mu12_pp(PGenMu2[i].Eta(), 1);
               TreeMu2TnP3P1 = 1;
               
               TreeMu1TnP1N1 = tnp_weight_TightID_pp(PGenMu1[i].Eta(), -1);
               TreeMu1TnP2N1 = tnp_weight_L3Mu12_pp(PGenMu1[i].Eta(), -1);
               TreeMu1TnP3N1 = 1;
               TreeMu2TnP1N1 = tnp_weight_TightID_pp(PGenMu2[i].Eta(), -1);
               TreeMu2TnP2N1 = tnp_weight_L3Mu12_pp(PGenMu2[i].Eta(), -1);
               TreeMu2TnP3N1 = 1;
            }
