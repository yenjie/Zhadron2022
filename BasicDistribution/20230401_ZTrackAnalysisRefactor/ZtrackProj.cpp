...
const char *typeofdata = "v15/20230621/UEDown25";
const char *typeofdata1 = "v15_UEDown25";
...
//void ZtrackProj(){
   ...
   file_bkgMC = TFile::Open("GraphMCBackgroundUEDown25_v15.root","read");
   file_sigDA = TFile::Open("GraphDataSignal_v14.root","read");
   //file_bkgDA = TFile::Open("GraphDataBackground_v15.root","read");
   file_bkgDA = TFile::Open("GraphDatabkgUEDown25_v15.root","read");
