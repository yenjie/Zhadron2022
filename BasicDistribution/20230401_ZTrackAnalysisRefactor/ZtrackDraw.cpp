...
*/
   ...
   max1 = hMC_sb_WTAetaphi->Integral(max_x-5,max_x-3,max_y-1,max_y+1)/9.;
   hMC_sb_WTAetaphi->SetMaximum(fabs(max1)*5);
   max_bin = hData_sb_WTAetaphi->GetMaximumBin(max_x,max_y,max_z);
   max2 = hData_sb_WTAetaphi->Integral(max_x-5,max_x-3,max_y-1,max_y+1)/9.;
   hData_sb_WTAetaphi->SetMaximum(fabs(max2)*5);
   ...
   hMC_sbr_WTAetaphi->SetMaximum(fabs(max1)*5);
   ...
   hData_sbr_WTAetaphi->SetMaximum(fabs(max2)*5);
   ...
   hMC_sb_WTAMoreetaphi->SetMaximum(fabs(max1)*5);
   ...
   hData_sb_WTAMoreetaphi->SetMaximum(fabs(max2)*5);
   ...
   hMC_sbr_WTAMoreetaphi->SetMaximum(fabs(max1)*5);
   ...
   hData_sbr_WTAMoreetaphi->SetMaximum(fabs(max2)*5);
   ...
   */
   ...
   hMC_Zsb_WTAetaphi->SetMaximum(fabs(max1)*5);
   ...
   hData_Zsb_WTAetaphi->SetMaximum(fabs(max2)*5);
   ...
   hMC_Zsbr_WTAetaphi->SetMaximum(fabs(max1)*5);
   ...
   hData_Zsbr_WTAetaphi->SetMaximum(fabs(max2)*5);
   ...
   hMC_Zsb_WTAMoreetaphi->SetMaximum(fabs(max1)*5);
   ...
   hData_Zsb_WTAMoreetaphi->SetMaximum(fabs(max2)*5);
   ...
   hMC_Zsbr_WTAMoreetaphi->SetMaximum(fabs(max1)*5);
   ...
   hData_Zsbr_WTAMoreetaphi->SetMaximum(fabs(max2)*5);
