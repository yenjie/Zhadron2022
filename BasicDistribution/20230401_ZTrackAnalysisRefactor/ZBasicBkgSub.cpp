...
const char *typeofdata = "v17d_PFMuon/20240103/SigBkg_50";
const char *typeofdata1 = "50_ov10";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCSigBkg_v17d_PFmuon.root","read");
   else
