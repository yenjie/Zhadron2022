...
const char *typeofdata = "v17d_PFMuon/20240103/SigBkg_Cent10";
const char *typeofdata1 = "300_ov10";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCSigBkg_v17d_Cent10_300.root","read");
   else
