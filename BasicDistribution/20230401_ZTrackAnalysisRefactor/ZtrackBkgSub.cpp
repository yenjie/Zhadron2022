...
const char *typeofdata = "v17d_PFMuon/20231229/nominal";
const char *typeofdata1 = "noHF";
...
int main(int argc, char *argv[]){
   ...
   file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v17d_noHF.root","read");
