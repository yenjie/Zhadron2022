...
const char *typeofdata = "v17b_PFMuon/20231216";
const char *typeofdata1 = "v17b_PF_rejZ_Cent10";
...
int main(int argc, char *argv[]){
   ...
   file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCSigBkg_v17b_rejZ_Cent10.root","read");
   ...
   file_ppbkgMC  = TFile::Open("~/eos_base/BasicPlots/GraphPPMCSigBkg_v17b_rejZ_Cent10.root","read");
