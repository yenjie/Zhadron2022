...
int main(int argc, char *argv[]){
   ...
   file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCSigBkg_v17b_ov1_01.root","read");
   ...
   file_ppbkgMC  = TFile::Open("~/eos_base/BasicPlots/GraphPPMCSigBkg_v17b_ov1_01.root","read");
