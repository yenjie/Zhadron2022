...
const char *typeofdata = "v17b_PFMuon/20231217";
const char *typeofdata1 = "tor100_01";
...
int main(int argc, char *argv[]){
   ...
   file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCSigBkg_v17b_tor100_01.root","read");
   ...
   file_ppbkgMC  = TFile::Open("~/eos_base/BasicPlots/GraphPPMCSigBkg_v17b_tor100_01.root","read");
