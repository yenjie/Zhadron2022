...
const char *typeofdata = "v17_PFMuon/20231123/UEDown50";
const char *typeofdata1 = "v17_PF_20231123_UEDown50";
...
*/
   ...
   leg1.AddEntry(hMC_bkg_phi_com ,"bkg (UEDown50)","lep");
...
int main(int argc, char *argv[]){
   ...
   file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackgroundUEDown50_v17_PFmuon.root","read");
