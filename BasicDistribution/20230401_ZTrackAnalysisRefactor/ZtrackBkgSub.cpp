...
const char *typeofdata = "v17_PFMuon/20231123/UEUp30";
const char *typeofdata1 = "v17_PF_20231123_UEUp30";
...
*/
   ...
   leg1.AddEntry(hMC_bkg_phi_com ,"bkg (UEUp30)","lep");
...
int main(int argc, char *argv[]){
   ...
   file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackgroundUEUp30_v17_PFmuon.root","read");
