...
const char *typeofdata = "v17d_PFMuon/20231228/nominal";
const char *typeofdata1 = "cent10_noVZ";
...
int main(int argc, char *argv[]){
   ...
   file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v17d_cent10_noVZ.root","read");
