...
const char *typeofdata = "v17_PFMuon/20231123/UEDown30";
const char *typeofdata1 = "v17_PF_20231123_UEDown30";
...
*/
   ...
   leg1.AddEntry(hMC_bkg_phi_com ,"bkg (UEDown30)","lep");
...
int main(int argc, char *argv[]){
   ...
   file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackgroundUEDown30_v17_PFmuon.root","read");
