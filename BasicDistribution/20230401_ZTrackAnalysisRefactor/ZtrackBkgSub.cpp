...
const char *typeofdata1 = "v17b_tor50";
...
int main(int argc, char *argv[]){
   ...
   file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCSigBkg_v17b_tor50.root","read");
   ...
   file_ppbkgMC  = TFile::Open("~/eos_base/BasicPlots/GraphPPMCSigBkg_v17b_tor50.root","read");
