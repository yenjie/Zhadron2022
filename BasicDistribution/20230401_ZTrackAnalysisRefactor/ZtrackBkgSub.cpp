...
const char *typeofdata = "v17d_PFMuon/20231222";
const char *typeofdata1 = "SigBkg_Cent10";
...
int main(int argc, char *argv[]){
   ...
   file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCSigBkg_v17d_Cent10.root","read");
   ...
   file_ppbkgMC  = TFile::Open("~/eos_base/BasicPlots/GraphPPMCSigBkg_v17d_Cent10.root","read");
