...
do
   ...
   PlottingY="--XAxisLabel |#Deltay_{trk,Z}| --YAxisLabel <#DeltaN_{ch}>/event --RAxisLabel Difference --XMin 0 --XMax 3.2 --YMin -20 --YMax 30 --RMin -7 --RMax 7 --LegendLeft 0.08 --LegendBottom 0.40"
