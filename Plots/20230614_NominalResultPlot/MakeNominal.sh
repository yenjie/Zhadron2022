...
do
   ...
   Plotting="--XAxisLabel |#Delta#phi_{trk,Z}| --YAxisLabel N_{ch}/event --RAxisLabel Difference --XMin 0 --XMax 3.1415926535 --YMin -6 --YMax 15 --RMin -7 --RMax 7 --LegendLeft 0.08 --LegendBottom 0.40"
   Suffix="C$CMin$CMax"
...
#
   ...
   Plotting="--XAxisLabel |#Deltay_{trk,Z}| --YAxisLabel N_{ch}/event --RAxisLabel Difference --XMin 0 --XMax 3.2 --YMin -6 --YMax 12 --RMin -7 --RMax 7 --LegendLeft 0.08 --LegendBottom 0.40"
