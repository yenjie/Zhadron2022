...
do
   ...
   Plotting="--XAxisLabel |#Delta#phi_{trk,Z}| --YAxisLabel <#DeltaN_{ch}>/event --RAxisLabel Difference --XMin 0 --XMax 3.1415926535 --YMin 0.1 --YMax 1000 --RMin -7 --RMax 7 --LegendLeft 0.08 --LegendBottom 0.40"
   Suffix="C$CMin$CMax"
   ...
   ./Execute --OutputBase Plots/ResultNominal/ResultNominal$Suffix \
      ...
      --CurveLabels "pp","PbPb" \
      --ToPlot "DeltaPhi" \
      --Tags "$Tags" --Labels "$Labels" --ExtraInfo "$ExtraInfo" --TagShifts "$TagShifts" --SkipShifting false --LogScale true \
      $Plotting
...
#
   ...
   Plotting="--XAxisLabel |#Deltay_{trk,Z}| --YAxisLabel <#DeltaN_{ch}>/event --RAxisLabel Difference --XMin 0 --XMax 3.2 --YMin 0.1 --YMax 1000 --RMin -7 --RMax 7 --LegendLeft 0.08 --LegendBottom 0.40"
   ...
   ./Execute --OutputBase Plots/ResultNominal/ResultNominalY$Suffix \
      ...
      --SystematicFiles Sys/PPAll.root,Sys/PbPbAll.root --SkipSystematics false  --TagShifts "$TagShifts" --SkipShifting false --LogScale true \
      --CurveLabels "pp","PbPb" \
      --ToPlot "DeltaY" \
      --Tags "$Tags" --Labels "$Labels" --ExtraInfo "$ExtraInfo" \
      $Plotting
