...
mkdir -p /eos/user/p/pchou/figs/ResultNominal/20240122/v17d_NoShiftNoSelfSub_UE
...
do
   ...
   ./Execute --OutputBase /eos/user/p/pchou/figs/ResultNominal/20240122/v17d_NoShiftNoSelfSub_UE/ResultNominal$Suffix \
