...
mkdir -p /eos/user/p/pchou/figs/ResultNominal/20240122/v17d_WithShiftNoSelfSub_UE
...
do
   ...
   ./Execute --OutputBase /eos/user/p/pchou/figs/ResultNominal/20240122/v17d_WithShiftNoSelfSub_UE/ResultNominal$Suffix \
...
#
   ...
   ./Execute --OutputBase /eos/user/p/pchou/figs/ResultNominal/20240122/v17d_WithShiftNoSelfSub_UE/ResultNominalY$Suffix \
      --DataFiles Root/PPData.root,Root/Data.root \
      --SubtractFiles None,Root/DataMix.root --SkipSubtract false --WithSelfSubtract false \
      ...
      --Tags "$Tags" --Labels "$Labels" --ExtraInfo "$ExtraInfo" \
      $Plotting
   ./Execute --OutputBase /eos/user/p/pchou/figs/ResultNominal/20240122/v17d_WithShiftNoSelfSub_UE/ResultNominalYJetSide$Suffix \
      --DataFiles Root/PPData.root,Root/Data.root \
      --SubtractFiles None,Root/DataMix.root --SkipSubtract false --WithSelfSubtract false \
      --SystematicFiles Sys/PPAll.root,Sys/PbPbAll_UE.root --SkipSystematics false  --TagShifts "$TagShifts" --SkipShifting false \
      --CurveLabels "pp","PbPb" \
      ...
      --Tags "$Tags" --Labels "$Labels" --ExtraInfo "$ExtraInfo" \
      $Plotting
   ./Execute --OutputBase /eos/user/p/pchou/figs/ResultNominal/20240122/v17d_WithShiftNoSelfSub_UE/ResultNominalYZSide$Suffix \
      --DataFiles Root/PPData.root,Root/Data.root \
      --SubtractFiles None,Root/DataMix.root --SkipSubtract false --WithSelfSubtract false \
      --SystematicFiles Sys/PPAll.root,Sys/PbPbAll_UE.root --SkipSystematics false  --TagShifts "$TagShifts" --SkipShifting false \
      --CurveLabels "pp","PbPb" \
   ...
   ./Execute --OutputBase /eos/user/p/pchou/figs/ResultNominal/20240122/v17d_WithShiftNoSelfSub_UE/ResultNominalEta$Suffix \
      --DataFiles Root/PPData.root,Root/Data.root \
      --SubtractFiles None,Root/DataMix.root --SkipSubtract false --WithSelfSubtract false \
      --SystematicFiles Sys/PPAll.root,Sys/PbPbAll_UE.root --SkipSystematics false  --TagShifts "$TagShifts" --SkipShifting false \
      --CurveLabels "pp","PbPb" \
      ...
      --Tags "$Tags" --Labels "$Labels" --ExtraInfo "$ExtraInfo" \
      $Plotting
   ./Execute --OutputBase /eos/user/p/pchou/figs/ResultNominal/20240122/v17d_WithShiftNoSelfSub_UE/ResultNominalEtaJetSide$Suffix \
      --DataFiles Root/PPData.root,Root/Data.root \
      --SubtractFiles None,Root/DataMix.root --SkipSubtract false --WithSelfSubtract false \
      --SystematicFiles Sys/PPAll.root,Sys/PbPbAll_UE.root --SkipSystematics false  --TagShifts "$TagShifts" --SkipShifting false \
      --CurveLabels "pp","PbPb" \
      ...
      --Tags "$Tags" --Labels "$Labels" --ExtraInfo "$ExtraInfo" \
      $Plotting
   ./Execute --OutputBase /eos/user/p/pchou/figs/ResultNominal/20240122/v17d_WithShiftNoSelfSub_UE/ResultNominalEtaZSide$Suffix \
      --DataFiles Root/PPData.root,Root/Data.root \
      --SubtractFiles None,Root/DataMix.root --SkipSubtract false --WithSelfSubtract false \
      --SystematicFiles Sys/PPAll.root,Sys/PbPbAll_UE.root --SkipSystematics false  --TagShifts "$TagShifts" --SkipShifting false \
      --CurveLabels "pp","PbPb" \
